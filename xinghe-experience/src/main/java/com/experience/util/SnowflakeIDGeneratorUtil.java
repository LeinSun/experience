...
public class SnowflakeIDGeneratorUtil {
    ...
    private static SnowflakeIDGeneratorUtil snowflakeIdUtil;
    //==============================Constructors=====================================
    ...
    static {
        ...
        snowflakeIdUtil = new SnowflakeIDGeneratorUtil(workerId, datacenterId);
    }
    ...
    public static void main(String[] args) {
        System.out.printf("" + SnowflakeIDGeneratorUtil.newId());
    }
